...
const Navbar = () => {
    ...
    return (
        <>
            <header className="fixed inset-x-0 top-0 z-50 px-4 pt-4 md:px-6 md:pt-6 lg:px-10">
                <div className="mx-auto">
                    <div
                        className={`flex items-center justify-between gap-4 transition-all duration-300 ${scrolled ? "scale-[0.99]" : "scale-100"
                            }`}
                    >
                            ...
                            {navItems.map((item) => (
                                ...
                                >
                                    <div
                                        ...
                                        style={{ transitionDuration: '450ms', transitionTimingFunction: 'var(--elastic-ease-out)' }}
                                    >
                                    ...
                                    <span
                                        ...
                                        style={{ transitionDuration: '750ms', transitionTimingFunction: 'var(--elastic-ease-out)' }}
                                    >
                                        {item.name}
                                    </span>
                                    <span
                        ...
                        <div className="hidden md:flex items-center">
                            ...
                            >
                                ...
                                <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-white">
                                    <img src={fireImg} className="h-7 w-7 object-contain" alt="" />
                                </span>
                            </a>
                        </div>
                        ...
                        >
                            <span className="relative block h-5 w-5">
                                <span
                                    className={`absolute left-0 top-[2px] h-[2px] w-5 rounded-full bg-black transition-all duration-300 ${open ? "top-[9px] rotate-45" : ""
                                        }`}
                                />
                                <span
                                    className={`absolute left-0 top-[9px] h-[2px] w-5 rounded-full bg-black transition-all duration-300 ${open ? "opacity-0" : "opacity-100"
                                        }`}
                                />
                                <span
                                    className={`absolute left-0 top-[16px] h-[2px] w-5 rounded-full bg-black transition-all duration-300 ${open ? "top-[9px] -rotate-45" : ""
                                        }`}
                                />
                            </span>
                        </button>
