...
const Hero = () => {
    ...
    return (
        <>
            <section className="px-4 pb-10 pt-32 sm:px-6 sm:pt-36 lg:px-10 lg:pb-12 lg:pt-50">
            ...
            <section className="overflow-hidden px-4 pb-10 sm:px-6 lg:px-10 lg:pb-16">
                <div className="mx-auto">
                    <div className="grid grid-cols-2 gap-4 lg:grid-cols-4 lg:gap-0">
                        <div
                            onMouseEnter={() => setActiveCard(1)}
                            onMouseLeave={() => setActiveCard(null)}
                            className={`relative z-[1] min-h-[250px] rounded-[34px] bg-sky-500 p-6 shadow-sm transition-all duration-[700ms] ease-[cubic-bezier(0.22,1,0.36,1)] sm:p-7 lg:min-h-[600px] lg:px-9 lg:py-8 ${getCardClasses(
                                1,
                        ...
                        >
                            ...
                            <div className="mt-28 lg:mt-[330px]">
                        ...
                        <div
                            ...
                            onMouseLeave={() => setActiveCard(null)}
                            className={`relative z-[2] min-h-[250px] overflow-hidden rounded-[34px] bg-neutral-100 shadow-sm transition-all duration-[700ms] ease-[cubic-bezier(0.22,1,0.36,1)] lg:min-h-[600px] ${getCardClasses(
                                2,
                        ...
                        <div
                            ...
                            onMouseLeave={() => setActiveCard(null)}
                            className={`relative z-[3] hidden min-h-[600px] rounded-[34px] bg-emerald-400 px-9 py-8 shadow-sm transition-all duration-[700ms] ease-[cubic-bezier(0.22,1,0.36,1)] lg:block ${getCardClasses(
                                3,
                        ...
                        <div
                            ...
                            onMouseLeave={() => setActiveCard(null)}
                            className={`relative z-[4] hidden min-h-[600px] overflow-hidden rounded-[34px] bg-neutral-200 shadow-sm transition-all duration-[700ms] ease-[cubic-bezier(0.22,1,0.36,1)] lg:block ${getCardClasses(
                                4,
